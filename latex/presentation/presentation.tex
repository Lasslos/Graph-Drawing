...
\begin{frame}{Introduction}
    Graphs are a prominent object in modern mathematics, useful for abstracting complex real-life situations.
    \begin{itemize}
...
\begin{frame}
    ...
    \end{itemize}
    $\implies$ ERLL spreads out ``big nodes'' compared to FR, useful in highly non-uniform graphs
\end{frame}
